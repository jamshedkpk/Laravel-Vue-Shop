                                ...
                                <div class="col-md-4">
                                    <div class="single-product-items">
                                        <div class="product-item-image">
                                            <a href="#"><img src="{{ asset('user_template/assets/images/product/p-1.jpg') }}" alt="Product"></a>
                        ...
                        <div class="product-items mt-30">
                            <div class="row product-items-active">
                                ...
                                <div class="col-md-4">
                                    <div class="single-product-items">
                                        <div class="product-item-image">
                                            <a href="#"><img src="{{ asset('user_template/assets/images/product/p-2.jpg') }}" alt="Product"></a>
                                            <div class="product-discount-tag">
                                                <p>-60%</p>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="single-product-items">
                                        <div class="product-item-image">
                                            <a href="#"><img src="{{ asset('user_template/assets/images/product/p-3.jpg') }}" alt="Product"></a>
                                            <div class="product-discount-tag">
                                                <p>-60%</p>
                                            </div>
                                        </div>
                        ...
                        <div class="product-items mt-30">
                            <div class="row product-items-active">
                                ...
                                <div class="col-md-4">
                                    <div class="single-product-items">
                                        <div class="product-item-image">
                                            <a href="#"><img src="{{ asset('user_template/') }}" alt="Product"></a>
                                            <div class="product-discount-tag">
                                                <p>-60%</p>
                                            </div>
                                        </div>

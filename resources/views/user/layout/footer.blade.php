...
<!--====== jquery js ======-->
<script src="{{ asset('user_template/assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
<script src="{{ asset('user_template/assets/js/vendor/jquery-1.12.4.min.js') }}"></script>
...
<!--====== Slick js ======-->
<script src="{{ asset('user_template/assets/js/slick.min.js') }}"></script>

<!--====== Magnific Popup js ======-->
<script src="{{ asset('user_template/assets/js/jquery.magnific-popup.min.js') }}"></script>


<!--====== nav js ======-->
<script src="{{ asset('user_template/assets/js/jquery.nav.js') }}"></script>

<!--====== Nice Number js ======-->
<script src="{{ asset('user_template/assets/js/jquery.nice-number.min.js') }}"></script>
